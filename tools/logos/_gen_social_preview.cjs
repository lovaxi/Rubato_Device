...
(async () => {
  ...
  const fade = Buffer.from(`<svg width="1280" height="640">
    ...
    <text x="68" y="368" fill="#929292" font-family="sans-serif" font-size="38">When AI thinks, you move.</text>
    <text x="68" y="428" fill="#5A5A5A" font-family="sans-serif" font-size="27">Health breaks for programmers &amp; heavy AI users.</text>
  </svg>`);
