...
(async () => {
  ...
  const fade = Buffer.from(`<svg width="1280" height="640">
    ...
    <text x="66" y="300" fill="#FFFFFF" font-family="sans-serif" font-weight="bold" font-size="118">Rubato</text>
    <text x="68" y="368" fill="#FFFFFF" font-family="sans-serif" font-size="38">When AI thinks, you move.</text>
    <text x="68" y="430" fill="#FFFFFF" font-family="sans-serif" font-size="30">Health breaks for programmers &amp; heavy AI users.</text>
  </svg>`);
