...
Thinktime makes your AI's working state visible — on a physical desk device. The device plugins lives at [Thinktime_Device](https://github.com/lovaxi/Thinktime_Plugins).
